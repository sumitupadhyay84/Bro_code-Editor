...
function FilesView() {
    ...
    return (
        <div
            className="flex select-none flex-col gap-1 px-4 py-2 bg-[#8344697b]"
        ...
        >
            ...
            >
                <hr />
                <button
                    className="mt-2 flex w-full justify-start rounded-md p-2 transition-all hover:bg-[#442543]"
                ...
                <button
                    className="flex w-full justify-start rounded-md p-2 transition-all hover:bg-[#442543]"
