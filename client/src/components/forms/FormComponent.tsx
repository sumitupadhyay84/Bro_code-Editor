        ...
        <div className="flex max-h-[900px] w-full max-w-[500px] flex-col items-center justify-center gap-4 sm:w-[500px] sm:p-8 bg-[#1a1417c9] p-4 shadow-2xl shadow-[#252525] rounded-2xl">
            ...
            <form onSubmit={joinRoom} className="flex w-full flex-col gap-4">
                <input
                    ...
                    name="roomId"
                    placeholder="Room Id"
                    className="w-full rounded-md border border-gray-500 bg-[#443042b1] px-3 py-3 focus:outline-none"
                ...
                <button
                    type="submit"
                    className="mt-2 w-full rounded-md bg-[#442543] px-8 py-3 text-lg font-semibold text-[#998399a6]"
                >
                    Join
                </button>
            </form>
