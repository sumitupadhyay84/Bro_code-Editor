...
function ChatList() {
    ...
    return (
        <div
            className="flex-grow overflow-auto rounded-md bg-[#442543] p-2"
            ...
            {messages.map((message, index) => {
                return (
                    <div
                        key={index}
                        className={
                            "mb-2 w-[80%] self-end break-words rounded-md bg-[#8344697b] px-3 py-2" +
                    ...
                    >
                        <div className="flex justify-between">
                            <span className="text-xs text-[#f8d5f7]">
                                {message.username}
                            </span>
