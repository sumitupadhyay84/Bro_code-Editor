...
function SettingsView() {
    ...
    return (
        <div
            className="flex flex-col items-center gap-2 p-4 bg-[#8344697b]"
        ...
        >
            ...
            <div className="flex w-full items-end gap-2">
                ...
                <select
                    ...
                    className="rounded-md border-none bg-[#442543] px-4 py-2 text-white outline-none"
                    title="Font Size"
                >
            ...
            <button
                className="mt-auto w-full rounded-md border-none bg-[#f8d5f7] px-4 py-2 text-[#442543] outline-none"
